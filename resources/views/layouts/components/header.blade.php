...
<!-- ========== HEADER ========== -->
    ...
    <div class="hs-dropdown relative inline-flex [--placement:bottom-left] sm:[--trigger:hover]">
        ...
        @if (Auth::user() == null)
            ...
            <div>
                <a href="{{route('login')}}" class="btn font-medium hover:bg-blue-700 py-2" aria-current="page">
                    <button>Se connecter</button>
                </a>
                <a href="{{route('register')}}" class="btn font-medium hover:bg-blue-700 py-2" aria-current="page">
